...
import bodyParser from 'body-parser';  //used for post requests
...
const CONNECTION_URL = 'mongodb+srv://himalaya:kathpal1@cluster0.mg7jr.mongodb.net/<dbname>?retryWrites=true&w=majority';
